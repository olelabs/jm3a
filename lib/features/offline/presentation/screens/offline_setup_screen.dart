            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  Text(context.l10n.offlineLoadingCards),
                ],
              ),
            );
          }
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      provider.error ?? context.l10n.offlineSetupFailed,
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        context.l10n.offlinePackMeta(
                          pack.cardCount,
                          pack.language.toUpperCase(),
                          pack.isFree ? context.l10n.roomsIconFree : context.l10n.purchased,
                        ),
                ...
                if (pack.expiresAt != null)
                  Text(
                    context.l10n.offlinePackExpiry(pack.expiresAt!.day, pack.expiresAt!.month),
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Text(
              context.l10n.offlineNoPacksDownloaded(gameType.displayName),
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Row(
          children: [
            SizedBox(width: 100, child: Text(context.l10n.offlineRoundsSlider(maxRounds))),
            Expanded(
              child: Slider(
        ...
        SwitchListTile(
          title: Text(context.l10n.gameSettingsAllowSkip),
          value: allowSkip,
        ...
        SwitchListTile(
          title: Text(context.l10n.offlineSpicyContent),
          subtitle: Text(context.l10n.offlineEnable18Cards),
          value: allowSpicy,
        ...
        SwitchListTile(
          title: Text(context.l10n.gameSettingsTurnTimer),
          value: timerEnabled,
        ...
        if (timerEnabled)
          Row(
            children: [
              Expanded(child: Text(context.l10n.offlineTimerSecsLabel(timerSecs))),
              Slider(
