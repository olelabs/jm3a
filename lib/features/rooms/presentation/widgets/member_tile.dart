...
// //                 leading: const Icon(Icons.shield_outlined),
// //                 title: Text(
// //                   member.isModerator ? 'Revoke moderator' : 'Make moderator',
// //                 ),
// //                 onTap: () {
// //                   Navigator.pop(ctx);
// //                   onToggleModerator?.call();
// //                 },
// //               ),
// //             if (onTransferOwnership != null)
// //               ListTile(
                      ...
                      if (member.isOwner)
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: Text(
                              'MOD · ${member.moderatorPermissions.length}',
                              style: TextStyle(
                                fontSize: 9,
                                fontWeight: FontWeight.w800,
                                color: AppColors.amberOrangeLight,
          ...
          children: [
            ...
            if (onManagePermissions != null)
              ListTile(
                ...
                title: Text(
                  member.isModerator
                      ? 'Manage permissions (${member.moderatorPermissions.length})'
                      : 'Make moderator',
                ),
                onTap: () {
                  Navigator.pop(ctx);
